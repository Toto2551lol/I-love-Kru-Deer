...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'List08ProductListCopy',
          path: '/list08ProductListCopy',
          builder: (context, params) => List08ProductListCopyWidget(),
        ),
        FFRoute(
          name: 'mainpatient',
          path: '/mainpatient',
          builder: (context, params) => MainpatientWidget(),
        ),
        FFRoute(
          name: 'mainpatientCopy',
          path: '/mainpatientCopy',
          builder: (context, params) => MainpatientCopyWidget(),
        ),
        FFRoute(
          name: 'chat_2_Details',
          path: '/chat2Details',
        ...
        FFRoute(
          name: 'mainpatientCopyCopy',
          path: '/mainpatientCopy2',
          builder: (context, params) => MainpatientCopyCopyWidget(),
        )
